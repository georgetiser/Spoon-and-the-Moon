...
navigation.DisplayDevelopmentVersion()
       ...
       local kwkPageCorner 
       local kwkBforward         --local PageXCorner         local CH7PG8  --(2) regular layer        CH7PG8 = display.newImageRect(imageDir .. "p106_ch7pg8.png", 768, 1024 );        CH7PG8.x = 384; CH7PG8.y = 512; CH7PG8.alpha = 1; CH7PG8.oldAlpha = 1        menuGroup:insert(CH7PG8)        menuGroup.CH7PG8 = CH7PG8 
--XPageXCornerX
