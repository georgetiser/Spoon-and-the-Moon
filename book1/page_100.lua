...
navigation.DisplayDevelopmentVersion()
       ...
       local kwkPageCorner 
       local kwkBforward         --local PageXCorner         local CH7PG1  --(2) regular layer        CH7PG1 = display.newImageRect(imageDir .. "p99_ch7pg1.png", 768, 1024 );        CH7PG1.x = 384; CH7PG1.y = 512; CH7PG1.alpha = 1; CH7PG1.oldAlpha = 1        menuGroup:insert(CH7PG1)        menuGroup.CH7PG1 = CH7PG1 
--XPageXCornerX
