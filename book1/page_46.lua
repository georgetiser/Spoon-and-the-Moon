...
navigation.DisplayDevelopmentVersion()
       ...
       local kwkPageCorner 
       local kwkBforward         local chapt1mup2         --local PageXCorner         local BG         BG = display.newImageRect(imageDir .. "p23_bg.png", 768, 1024 );        BG.x = 384; BG.y = 512; BG.alpha = 1; BG.oldAlpha = 1        menuGroup:insert(BG)        menuGroup.BG = BG 
--XPageXCornerX
