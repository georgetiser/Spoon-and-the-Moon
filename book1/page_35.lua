...
module(..., package.seeall) 
    ...
    --DEBUGTEXTEND
       ...
       local kwkPageCorner 
       local kwkBforward         --local PageXCorner         local BG  --(2) regular layer        BG = display.newImageRect(imgDir .. "p12_bg.png", 768, 1024 );        BG.x = 384; BG.y = 512; BG.alpha = 1; BG.oldAlpha = 1        menuGroup:insert(BG)        menuGroup.BG = BG 
--XPageXCornerX
