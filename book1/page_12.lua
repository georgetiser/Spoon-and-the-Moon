-- Code created by Kwik - Copyright: kwiksher.com -- Version: 1.9.7a module(..., package.seeall)  function new()     local menuGroup = display.newGroup()     local disposeAudios     local disposeTweens     local kwkBindex_audio = audio.loadSound(audioDir .. "indexflip.mp3", system.ResourceDirectory)     --local currPage = 33 
    ...
    --DEBUGTEXTEND
       ...
       local kwkPageCorner 
       local kwkBforward         --local PageXCorner         local CH02PG9  --(2) regular layer        CH02PG9 = display.newImageRect(imgDir .. "p33_ch02pg9.png", 768, 1024 );        CH02PG9.x = 384; CH02PG9.y = 512; CH02PG9.alpha = 1; CH02PG9.oldAlpha = 1        menuGroup:insert(CH02PG9)        menuGroup.CH02PG9 = CH02PG9 
--XPageXCornerX
