...
navigation.DisplayDevelopmentVersion()
       ...
       local kwkPageCorner 
       local kwkBforward         local CH03PG11  --(2) regular layer        CH03PG11 = display.newImageRect(imageDir .. "p57_ch03pg11.png", 768, 1024 );        CH03PG11.x = 384; CH03PG11.y = 512; CH03PG11.alpha = 1; CH03PG11.oldAlpha = 1        menuGroup:insert(CH03PG11)        menuGroup.CH03PG11 = CH03PG11        local onkwkBforwardTouch = function(event)           if event.phase=="ended" then              local myClosure_switch = function()                 disposeAudios()
                disposeTweens() 
                print("GoForward!")
