...
navigation.DisplayDevelopmentVersion()
       ...
       local kwkPageCorner 
       local kwkBforward         --local PageXCorner         local CH7PG4  --(2) regular layer        CH7PG4 = display.newImageRect(imageDir .. "p102_ch7pg4.png", 768, 1024 );        CH7PG4.x = 384; CH7PG4.y = 512; CH7PG4.alpha = 1; CH7PG4.oldAlpha = 1        menuGroup:insert(CH7PG4)        menuGroup.CH7PG4 = CH7PG4 
--XPageXCornerX
