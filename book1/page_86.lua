...
navigation.DisplayDevelopmentVersion()
       ...
       local kwkPageCorner 
       local kwkBforward         local CH05PG16  --(2) regular layer        CH05PG16 = display.newImageRect(imageDir .. "p85_ch05pg16.png", 768, 1024 );        CH05PG16.x = 384; CH05PG16.y = 512; CH05PG16.alpha = 1; CH05PG16.oldAlpha = 1        menuGroup:insert(CH05PG16)        menuGroup.CH05PG16 = CH05PG16        local onkwkBforwardTouch = function(event)           if event.phase=="ended" then              local myClosure_switch = function()                 disposeAudios()
                disposeTweens() 
                print("GoForward!")
