...
navigation.DisplayDevelopmentVersion()
       ...
       local kwkPageCorner 
       local kwkBforward         local CH03PG8  --(2) regular layer        CH03PG8 = display.newImageRect(imageDir .. "p54_ch03pg8.png", 768, 1024 );        CH03PG8.x = 384; CH03PG8.y = 512; CH03PG8.alpha = 1; CH03PG8.oldAlpha = 1        menuGroup:insert(CH03PG8)        menuGroup.CH03PG8 = CH03PG8        local onkwkBforwardTouch = function(event)           if event.phase=="ended" then              local myClosure_switch = function()                 disposeAudios()
                disposeTweens() 
                print("GoForward!")
