...
navigation.DisplayDevelopmentVersion()
       ...
       local kwkPageCorner 
       local kwkBforward         local CH04PG7  --(2) regular layer        CH04PG7 = display.newImageRect(imageDir .. "p66_ch04pg7.png", 768, 1024 );        CH04PG7.x = 384; CH04PG7.y = 512; CH04PG7.alpha = 1; CH04PG7.oldAlpha = 1        menuGroup:insert(CH04PG7)        menuGroup.CH04PG7 = CH04PG7        local onkwkBforwardTouch = function(event)           if event.phase=="ended" then              local myClosure_switch = function()                 disposeAudios()
                disposeTweens() 
                print("GoForward!")
