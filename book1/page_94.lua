...
navigation.DisplayDevelopmentVersion()
       ...
       local kwkPageCorner 
       local kwkBforward         local CH06PG6  --(2) regular layer        CH06PG6 = display.newImageRect(imageDir .. "p93_ch06pg6.png", 768, 1024 );        CH06PG6.x = 384; CH06PG6.y = 512; CH06PG6.alpha = 1; CH06PG6.oldAlpha = 1        menuGroup:insert(CH06PG6)        menuGroup.CH06PG6 = CH06PG6        local onkwkBforwardTouch = function(event)           if event.phase=="ended" then              local myClosure_switch = function()                 disposeAudios()
                disposeTweens() 
                print("GoForward!")
