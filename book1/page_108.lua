...
navigation.DisplayDevelopmentVersion()
       ...
       local kwkPageCorner 
       local kwkBforward         --local PageXCorner         local CH7PG9  --(2) regular layer        CH7PG9 = display.newImageRect(imageDir .. "p107_ch7pg9.png", 768, 1024 );        CH7PG9.x = 384; CH7PG9.y = 512; CH7PG9.alpha = 1; CH7PG9.oldAlpha = 1        menuGroup:insert(CH7PG9)        menuGroup.CH7PG9 = CH7PG9 
--XPageXCornerX
