...
navigation.DisplayDevelopmentVersion()
       ...
       local kwkPageCorner 
       local kwkBforward         --local PageXCorner         local CH7PG5  --(2) regular layer        CH7PG5 = display.newImageRect(imageDir .. "p103_ch7pg5.png", 768, 1024 );        CH7PG5.x = 384; CH7PG5.y = 512; CH7PG5.alpha = 1; CH7PG5.oldAlpha = 1        menuGroup:insert(CH7PG5)        menuGroup.CH7PG5 = CH7PG5 
--XPageXCornerX
