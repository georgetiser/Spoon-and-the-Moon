-- Code created by Kwik - Copyright: kwiksher.com -- Version: 1.9.7a module(..., package.seeall)  function new()     local menuGroup = display.newGroup()     local disposeAudios     local disposeTweens     local kwkBindex_audio = audio.loadSound(audioDir .. "indexflip.mp3", system.ResourceDirectory)     --local currPage = 113 
    ...
    local path = system.pathForFile( "book.txt", system.DocumentsDirectory )     local file = io.open( path, "w+" )     file:write( _G.kwk_currentPage )     io.close( file )     local drawScreen = function()        local kwkBback         local kwkBindex  
       local kwkPageCorner 
       local kwkBforward         --local PageXCorner         local CH7PG16  --(2) regular layer        CH7PG16 = display.newImageRect(imgDir .. "p113_ch7pg16.png", 768, 1024 );        CH7PG16.x = 384; CH7PG16.y = 512; CH7PG16.alpha = 1; CH7PG16.oldAlpha = 1        menuGroup:insert(CH7PG16)        menuGroup.CH7PG16 = CH7PG16 
--XPageXCornerX
