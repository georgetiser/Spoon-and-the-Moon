...
function newObject(obj)
	...
	function obj:wtfIsGoingOn()
		...
		statusreport.debugPrint("new object")
		for k, v in pairs(self) do
			statusreport.debugPrint("k " .. k .. " type " .. type(v) .. " value " .. v)
		end
	end--wtf
	...
	if obj.categoryIncludes("button") then
		...
		local doWhenPressed = function(self, event)
			...
			if userPress == "ended" then
				statusreport.debugPrint("pressed")
	...
	statusreport.debugPrint(errMsg)
	return newObj
end
